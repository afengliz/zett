...
import (
	...
	testdata "github.com/afengliz/zett/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/afengliz/zett/framework/gin.handlerNameTest$", c.HandlerName())
}
